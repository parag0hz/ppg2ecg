...
def main():
    ...
    cfg = {
        ...
        "epochs_max": args.epochs, "early_stopping": {"metric": "val_mae_batchmean (full n_step Heun samples)", "patience": args.patience}, "checkpoint": "best val MAE",
    ...
    print("train subjects:", split["train"]); print("val subjects  :", split["val"]); print("test subjects :", split["test"])
